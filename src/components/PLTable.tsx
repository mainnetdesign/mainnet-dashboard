      ...
      <div className="bg-[var(--bg3)] border border-[var(--bd)]">
        <div className="p-6 pb-4">
          ...
          <div className="relative mb-4 no-print">
            <svg className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[var(--tx3)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 text-sm bg-[var(--bg)] border border-[var(--bd)] text-[var(--tx)] placeholder-[var(--tx3)] focus:outline-none focus:border-[var(--bd3)] transition-colors"
            />
            {search && (
              <button onClick={() => setSearch('')} className="absolute right-3 top-1/2 -translate-y-1/2 text-[var(--tx3)] hover:text-[var(--tx)]">
