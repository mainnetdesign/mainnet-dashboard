    ...
    <div className="bg-[var(--bg3)] p-6 border border-[var(--bd)]">
      ...
      <div className="space-y-5">
          ...
          <div key={c.id}>
            <div className="flex items-baseline justify-between mb-1">
              ...
              <div className="text-right">
                <span className="text-sm font-bold" style={{ color: '#FCA5A5' }}>{fmtBRL(c.totalCost)}</span>
        ...
        <div className="border-t border-[var(--bd)] pt-4 flex justify-between">
          ...
          <span className="text-sm font-bold" style={{ color: '#FCA5A5' }}>{fmtBRL(data.totalCostAllCollaborators)}</span>
        </div>
      </div>
    </div>
  )
